...
A good starting point for browsing through the many different types of data visualizations is to check out Chapter 5 in Wilke: [Directory of visualizations](https://serialmentor.com/dataviz/directory-of-visualizations.html)

In addition, some amazing people have put together beautiful interactive guides for making effective information visualizations:
