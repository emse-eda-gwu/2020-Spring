...
DataCamp assignments provide both instructional videos and applied practice writing code. Students should begin assignments prior to the associated lectures to prepare for class and are encouraged to take notes as they work. Assignments are listed on this website and within the course group on datacamp.com. Credit for each assignment will be allocated in proportion to the percentage of the assignment completed by the due date. No more than 2 late days can be used on any one assignment. Below is a summary of the DataCamp assignments:

**Quizzes**

There will be five quizzes given about once every two weeks immediately at the beginning of class. Quizzes cover material presented in class and previous assignments from the weeks since the most-recent quiz. Quizzes are designed to be time-intensive, to test for fluency, and to demonstrate where additional study is needed.

**Project Assignments**

Throughout the semester, small projects will be assigned to provide hands-on experience with the material covered in class. While students may work on these assignments in groups, each student must submit their own work.

**Final Project**

Throughout the semester, each student will work towards an individual final project. At the end of the semester, each student will submit a report of their analysis in the form of an html web page and give a 5-minute presentation of their results to the class. **There will be no final exam - the final project is the final exam.**

To make the overall project more manageable, it will be broken down into several separate "milestone" deliverables due throughout the semester. A 1-2 page project proposal is due at the end of the fourth week of class. A milestone report of 3-4 pages, including summary statistics and plots, is due immediately upon return from spring break. Presentations will take place during the final exam period.
...
Once you have read this entire syllabus and viewed the [course schedule](#schedule.html), please send me a picture of your favorite super hero in a direct message on Slack. For real. Brownie points if it's animated.

![](https://media.giphy.com/media/3o6ozmvFOsn1vvUcrS/giphy.gif){ width=250 }
