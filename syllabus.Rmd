...
Instructor | Course
---|---
<i class="fas fa-user"></i> John Paul Helveston | <i class="far fa-calendar"></i> TBD
...
<i class="fab fa-twitter"></i> [\@JohnHelveston](https://twitter.com/JohnHelveston) | <i class="fab fa-slack"></i> [Slack](https://emseeda.slack.com/)
...
Introduction to exploratory data analysis using the [R programming language](https://www.r-project.org/); topics include data visualization, data wrangling, reproducibility, information communication, webscraping, github, and rmarkdown.
...
Working in R (or any programming language) can be challenging - it's like learning a new language. Hadley Wickham - the chief data scientist at RStudio and the author of some amazing R packages you'll be using like **ggplot2** - [made this wise observation](https://r-posts.com/advice-to-young-and-old-programmers-a-conversation-with-hadley-wickham/):
...
This course does not require any textbooks. All texts, learning materials, and resources are freely available on the web. See the course [resources page](resources.html) for a list of useful resources.
...
------------------|-----|-----------------------------------
Homeworks (5)     | 25% | Lowest homework grade is dropped
Quizzes (4)       | 10% | Lowest quiz grade is dropped
Midterm Exams (2) | 20% | Lowest midterm grade is half-weighted
Final Exam        | 20% |
Term Project      | 20% |
...
Once you have read this entire syllabus and the [course schedule](#schedule.html), please send me a picture of a cute non-feline, non-canine animal in a direct message on Slack. For real. Brownie points if it's animated.
