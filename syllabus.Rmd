...
Students will be given a series of assignments throughout the semester. These will be a combination of exercises and mini projects. Exercises include instructional videos and applied practice writing code, mostly using the [DataCamp](https://www.datacamp.com/home) learning platform. Students should begin these assignments prior to the associated lectures to prepare for class and should take notes as they work. Mini project assignments provide hands-on experience with the material covered in class. While students may work with their peers on these assignments, each student must submit their own work. Credit for each assignment will be allocated according to a rubric provided in the assignment description. **No more than 2 late days can be used on any one assignment.**
...
Assignment 3                  | 5 %    | Exercises
Assignment 4                  | 5 %    | Redesign mini project
Assignment 5                  | 5 %    | Redesign mini project
Assignment 6                  | 5 %    | Exercises
Assignment 7                  | 5 %    | Exercises
