...
Throughout the semester, each student will work towards an individual final project. At the end of the semester, each student will submit a report of their analysis in the form of an html web page and give a 5-minute presentation of their results to the class. To make the overall project more manageable, it will be broken down into several separate "milestone" deliverables due throughout the semester. A 1-2 page project proposal is due at the end of the fourth week of class. A milestone report of 3-4 pages, including summary statistics and plots, is due immediately upon return from spring break. Presentations will take place during the final exam period. **There will be no final exam - the final project is the final exam.**
...
Project Assignments (3)    | 25%    |
Quizzes (Top 4)            | 20%    | Lowest quiz grade is dropped
Final Project              | 20%    |
</div>
