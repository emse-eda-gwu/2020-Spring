...
ggsave(here::here('images', 'plots', 'uk_cities.png'),
       uk_cities, width = 4.5, height = 4.5)
...
world_shapes <- st_read(here::here(
    'data', 'country_shapes', 'ne_50m_admin_0_countries.shp'),
