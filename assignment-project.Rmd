...
Item            | Weight towards<br>final grade | Due Date<br>(by 10pm)
----------------|----------------------------|--------------------
Proposal        | 5 %    | March 13
...
**Submission Details**: Submit your proposal as a PDF document on Blackboard by the due date.

**Tasks**:

Write a 1-2 page proposal of an exploratory data analysis that you plan to conduct for your final project. The instructors will review your proposal and provide feedback upon returning from spring break. If your proposal is approved, you're done and can move on towards the next project task. Otherwise, the instructors may ask you to submit a revised proposal, most likely by focusing / adjusting the proposal scope. Below is a list of specific items your proposal should include - the % in brackets indicates points towards this assignment grade:
...
4. [30%] Describe your anticipated results:
    ...
    - Describe how you would expect one variable you hope you find in your data to be distributed (e.g. unimodal, multimodel, tightly-group, widely-spread, etc.), regardless of whether that variable actually exists.
    - Describe one relationship you expect to find between two or more variables you hope to find in your data, regardless of whether those variables actually exist.
...
**Submission Details**: Your final report should be written as a .Rmd file that compiles to a webpage. Publish your compiled page online (e.g. via RPubs, Github, etc.), then submit your entire project folder (including your .Rmd file, data files, .RProj file, etc.) as a single .zip file on Blackboard by the due date. Also include a link to the published page in your Blackboard submission.
...
1. [10%] Follow these formatting rules:
    ...
    - Your report should be written in a narrative format (i.e. using coherent pargraphs rather than a series of bullet points). You may use headings where appropriate to break up your report into natural sections.
